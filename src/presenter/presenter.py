...
class Presenter(object):
    ...
    def __init__(self):
        ...
        self.purity_per_cluster = None
        self.purity_per_cluster_norm = None
        self.overall_purity = None

    def purity(self, labels_true, labels_pred, vectorizer, top_terms):
    ...
    def calc_similar_topics(self, top_terms, vectorizer):
